...
// Affidavit of Loss (PWD ID) content
$html = <<<EOD
<div style="text-align:center; font-size:12pt;">
    <b>AFFIDAVIT OF LOSS<br/>(PWD ID)</b>
</div>
<br/>
<div style="text-align:left; font-size:11pt;">
    ...
    1. That I am the ____________________________ of ____________________________, who is the lawful owner of a PWD ID issued by the City of Cabuyao;<br/><br/>
    2. That unfortunately the said PWD ID was lost under the following circumstance:<br/>
    ___________________________________________<br/>
    ___________________________________________<br/>
    ___________________________________________<br/><br/>
    3. That despite diligent efforts to retrieve the said PWD ID, the same can no longer be restored and therefore considered lost;<br/><br/>
...
// Output PDF
$pdf->Output('Affidavit_of_Loss_PWD_ID.pdf', 'D'); 